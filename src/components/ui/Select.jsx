...
export default forwardRef(function Select(
  ...
  return (
    <div className={`w-full ${className}`}>
      {label && (
        <label htmlFor={selectId} className="block text-[13px] font-medium text-[#333] mb-1.5">
          {label}
        </label>
      )}
      <select
        ...
        id={selectId}
        className={[
          'block w-full rounded-lg border bg-white text-[#333] text-sm px-3 py-2 transition-all appearance-none',
